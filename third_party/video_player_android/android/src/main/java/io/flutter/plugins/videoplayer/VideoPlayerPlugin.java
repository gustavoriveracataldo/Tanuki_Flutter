...
public class VideoPlayerPlugin implements FlutterPlugin, AndroidVideoPlayerApi {
  ...
  private static final String TANUKI_SURFACE_CHANNEL = "tanuki/video_player_android_surface";
  private final LongSparseArray<VideoPlayer> videoPlayers = new LongSparseArray<>();
  private FlutterState flutterState;
  private MethodChannel tanukiSurfaceChannel;
  ...
  public void onAttachedToEngine(@NonNull FlutterPluginBinding binding) {
    ...
    tanukiSurfaceChannel = new MethodChannel(
        binding.getBinaryMessenger(),
        TANUKI_SURFACE_CHANNEL);
    tanukiSurfaceChannel.setMethodCallHandler(
        (call, result) -> {
          if (!"setResizeMode".equals(call.method)) {
            result.notImplemented();
            return;
          }
          Number playerIdValue = call.argument("playerId");
          String mode = call.argument("mode");
          if (playerIdValue == null) {
            result.error("bad_args", "playerId is required", null);
            return;
          }
          int resizeMode = "fill".equals(mode)
              ? AspectRatioFrameLayout.RESIZE_MODE_FILL
              : AspectRatioFrameLayout.RESIZE_MODE_FIT;
          PlatformVideoView.setPlayerResizeMode(playerIdValue.longValue(), resizeMode);
          result.success(true);
        });
  }
  ...
  public void onDetachedFromEngine(@NonNull FlutterPluginBinding binding) {
    ...
    if (tanukiSurfaceChannel != null) {
      tanukiSurfaceChannel.setMethodCallHandler(null);
      tanukiSurfaceChannel = null;
    }
