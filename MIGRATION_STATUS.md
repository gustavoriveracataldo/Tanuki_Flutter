...
Ultima actualizacion: se fijo la version `0.8.7+87`, se agrego workflow de GitHub Actions para release multiplataforma en paralelo y se separaron las claves privadas locales de la configuracion publica del repo.
